...
class EvidencesFrame(customtkinter.CTkFrame):
    def __init__(self, master, disable_spirits):
        super().__init__(master)

        self.label_evidences = customtkinter.CTkLabel(master=self,text="EVIDENCES")
        self.label_evidences.grid(row=0, column=0, columnspan=1, padx=10, pady=10, sticky="")

        self.emf_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.spirit_box_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.fingerprints_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.ghost_orb_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.ghost_writing_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.freezing_temp_switch = customtkinter.CTkSwitch(
            master=self,
        ...
        self.DOTS_switch = customtkinter.CTkSwitch(
            master=self,
