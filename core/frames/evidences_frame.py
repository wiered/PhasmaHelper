...
from ..widgets import EvidenceSwitch
...
class EvidencesFrame(ctk.CTkFrame):
    def __init__(self, master, disable_spirits):
        ...
        self.emf_switch = EvidenceSwitch(
            master=self,
        ...
        self.spirit_box_switch = EvidenceSwitch(
            master=self,
        ...
        self.fingerprints_switch = EvidenceSwitch(
            master=self,
        ...
        self.ghost_orb_switch = EvidenceSwitch(
            master=self,
        ...
        self.ghost_writing_switch = EvidenceSwitch(
            master=self,
        ...
        self.freezing_temp_switch = EvidenceSwitch(
            master=self,
        ...
        self.DOTS_switch = EvidenceSwitch(
            master=self,
